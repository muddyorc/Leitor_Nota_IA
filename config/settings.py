...
REGRAS_DE_CLASSIFICACAO = {
    "INSUMOS AGRÍCOLAS": ["semente", "sementes", "fertilizante", "fertilizantes", "fert", "defensivo", "defensivos", "agrotóxico", "herbicida","inseticida","fungicida","adubo","corretivo","calcário"],
